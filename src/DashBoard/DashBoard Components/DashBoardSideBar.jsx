      ...
      <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        ...
        <div>
          ...
          <div className="mt-8 text-center">
            ...
            {
              isAdmin && <span className="hidden text-gray-400 lg:block">Admin</span>
            }
            {
              isMember && <span className="hidden text-gray-400 lg:block">Agent</span>
            }
            {
              isAdmin || isMember === false && <span className="hidden text-gray-400 lg:block">User</span>
            }
